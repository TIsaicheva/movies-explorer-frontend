      ...
      children={
        <section className="menu-mobile__container">    
          ...
          <div className="menu-mobile__links">
            <NavLink to="/" className="menu__link menu__link_mobile menu-mobile__link_main">
              Главная
            </NavLink>
            <NavLink
              to="/movies"
            ...
            <NavLink to="/saved-movies" className="menu__link menu__link_mobile">
              Сохранённые фильмы
            </NavLink>
          </div>

          <NavLink to="/profile" className="menu__link menu-mobile__account">
            Аккаунт
